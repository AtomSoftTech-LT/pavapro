...
#define DO			(PIND &	0x10)	/* Test for MMC DO ('H':true, 'L':false) */

#define DI_INIT()	DDRD  |= 0x40	/* Initialize port for MMC DI as output */
#define DI_H()		PORTD |= 0x40	/* Set MMC DI "high" */
#define DI_L()		PORTD &= 0xBF	/* Set MMC DI "low" */

#define CK_INIT()	DDRD  |= 0x20	/* Initialize port for MMC SCLK as output */
#define CK_H()		PORTD |= 0x20	/* Set MMC SCLK "high" */
#define	CK_L()		PORTD &= 0xDF	/* Set MMC SCLK "low" */
