...
#define DI_INIT()	DDRB  |= 0x10	/* Initialize port for MMC DI as output */
#define DI_H()		PORTB |= 0x10	/* Set MMC DI "high" */
#define DI_L()		PORTB &= 0xEF	/* Set MMC DI "low" */
...
#define CS_INIT()	DDRB  |= 0x02	/* Initialize port for MMC CS as output */
#define	CS_H()		PORTB |= 0x02	/* Set MMC CS "high" */
#define CS_L()		PORTB &= 0xFD	/* Set MMC CS "low" */
